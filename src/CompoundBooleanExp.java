...
public class CompoundBooleanExp {
    public static void main(String[] args) {
        /**
         * Use logic more complicated than just “less than” or “equal to”.
         * Project managers want software to be developed quickly, for minimal cost and at the highest quality.
